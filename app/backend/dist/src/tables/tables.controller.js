...
let TablesController = class TablesController {
    ...
    saveOrder(req, body) {
        return this.tablesService.saveOrder(body.tableNumber, JSON.stringify(body.cartData), body.total, req.user.companyId);
    }
    deleteOrder(req, tableNumber) {
...
], TablesController.prototype, "getPendingOrders", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Request)()),
    ...
    __metadata("design:returntype", void 0)
], TablesController.prototype, "saveOrder", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], TablesController.prototype, "deleteOrder", null);
